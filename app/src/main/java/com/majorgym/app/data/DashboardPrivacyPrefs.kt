...
/** The five Dashboard cards/sections that display a member count and can be
 *  individually hidden (Feature 3). */
enum class DashboardCard { TOTAL, ACTIVE, EXPIRING, EXPIRED, DUE }
 ...
 * - Per-[DashboardCard] number visibility (Feature 3): each of the five
