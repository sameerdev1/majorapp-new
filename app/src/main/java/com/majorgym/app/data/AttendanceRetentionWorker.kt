...
/**
 * Change 1: runs once a day (scheduled via [schedule] from MainActivity) and
 * deletes attendance records older than [ATTENDANCE_RETENTION_MONTHS].
 *
 * Does one small, self-contained thing - a plain indexed range delete on
 * attendance_records - and nothing else. It never touches members, member
 * deletion, attendance recording, QR/fingerprint check-in logic, or
